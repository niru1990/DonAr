...
public class donacionMain extends AppCompatActivity implements View.OnClickListener {
    ...
    private List<DonacionDTO> myLista = new ArrayList<>();
   private List<String> myList = new ArrayList<>();
    // private List<DonacionDTO> myList = new ArrayList<>();
...
@Override
    ...
    private void SaveDonacionId(String id) {
        SharedPreferences preferencias = getSharedPreferences
                ("ID usuario", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preferencias.edit();
        editor.putString("idDonacion", String.valueOf(idDonacion));
        editor.commit();
    }
