...
public class reportesDonaciones extends AppCompatActivity {
    ...
    private void generarPDF(String id){
/*
        ReportesPDF report = new ReportesPDF("Donacion"+ id + new fechas().getDateTime(),
                cargarDonacionTraza(id) );
 ...
 */
    ...
    private Object cargarDonacionTraza(String id) {
        return null;
    }
